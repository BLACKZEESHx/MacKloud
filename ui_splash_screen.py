...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        SplashScreen.setWindowTitle(QCoreApplication.translate("SplashScreen", u"MACKLOUD", None))
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>MACKLOUD</strong>", None))
        self.label_title.setStyleSheet("font-family: Game of Squids;color:#fe79c7;")
        self.label_description.setText(QCoreApplication.translate("SplashScreen", u"<strong>LOADING</strong> ...", None))
        self.label_loading.setText(QCoreApplication.translate("SplashScreen", u"loading...", None))
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Created</strong>: ABDULLAH MASHHOOD", None))
    # retranslateUi
